...
const source = document.getElementById('lofiSource');
...
function savePlayerState() {
    localStorage.setItem('lofiVolume', player.volume);
    localStorage.setItem('lofiCurrentTime', player.currentTime);
}

// Load the saved state from localStorage
function loadPlayerState() {
    const savedVolume = localStorage.getItem('lofiVolume');
    const savedCurrentTime = localStorage.getItem('lofiCurrentTime');
